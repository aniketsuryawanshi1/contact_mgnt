"""
Django settings for contact_mgnt project.
...
SECRET_KEY = 'django-insecure-rl$-!ihhia*^lqe*b#!v70wz3)g4g#8l(c%cm%tk**ee7or0ct'
...
ROOT_URLCONF = 'contact_mgnt.urls'
...
WSGI_APPLICATION = 'contact_mgnt.wsgi.application'
